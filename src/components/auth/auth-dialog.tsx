      ...
      if (mode === "sign-up") {
        ...
        if (referralCode.trim()) {
          try {
            ...
            // Referral processing failed silently — user still gets signup tokens
          }
        }
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {mode === "sign-in"
              ? t(
                  "Sign in to access AI-powered compliance tools.",
                  "AI 기반 컴플라이언스 도구를 사용하려면 로그인하세요.",
                )
              : t(
                  "Sign up to get 150 free tokens.",
                  "가입하면 150 무료 토큰을 받으세요.",
                )}
          </DialogDescription>
        </DialogHeader>
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              {mode === "sign-up" && (
                <Input
                  type="text"
                  placeholder={t("Referral code (optional)", "추천 코드 (선택사항)")}
                  value={referralCode}
